        ...
        <table className="hidden w-full text-sm lg:table">
          <thead className="sticky top-0 z-10 bg-slate-50 text-left text-xs text-slate-500">
            <tr>
              ...
              <th className="px-3 py-2.5 text-center font-medium"><span className="inline-flex items-center gap-1">Devolver <Hint text="No entregados que el motorizado tiene que traer de vuelta: devueltos / por devolver. Se reciben en Despacho del día, tarjeta «Devoluciones»." /></span></th>
