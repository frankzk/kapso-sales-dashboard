...
export async function updateStore(
  ...
  const patch = buildStoreUpdate({
    ...
    delivered_thanks_enabled: get("delivered_thanks_enabled"),
    delivered_thanks_template_name: get("delivered_thanks_template_name"),
    delivered_thanks_template_language: get("delivered_thanks_template_language"),
    delivered_thanks_params: get("delivered_thanks_params"),
    delivered_thanks_button_param: get("delivered_thanks_button_param"),
    delivered_thanks_phone_number_id: get("delivered_thanks_phone_number_id"),
    ...
    voice_recovery_daily_cap: get("voice_recovery_daily_cap"),
    voice_recovery_max_attempts: get("voice_recovery_max_attempts"),
    voice_recovery_max_age_days: get("voice_recovery_max_age_days"),
    voice_recovery_hour_start: get("voice_recovery_hour_start"),
    voice_recovery_hour_end: get("voice_recovery_hour_end"),
    voice_recovery_agent_number: get("voice_recovery_agent_number"),
